...
function getInput(evt) {
  ...
  document.querySelector(".results").innerHTML = run(modelParameters);
}

const $form = document.querySelector(".input");
$form.addEventListener("submit", getInput);

},{"@banana-dev/banana-dev":3}],2:[function(require,module,exports){
...
function runMain(apiKey, modelKey, modelInputs = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const callID = yield startAPI(apiKey, modelKey, modelInputs);
        while (true) {
...
const startAPI = (apiKey, modelKey, modelInputs) => __awaiter(void 0, void 0, void 0, function* () {
...
},{"_process":33,"axios":4,"uuid":34}],3:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
function run(apiKey, modelKey, modelInputs = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const out = yield genericsUtils.runMain(apiKey = apiKey, modelKey = modelKey, modelInputs = modelInputs);
        return out;
    });
}
exports.run = run;
function start(apiKey, modelKey, modelInputs = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const callID = yield genericsUtils.startMain(apiKey = apiKey, modelKey = modelKey, modelInputs = modelInputs);
        return callID;
    });
}
exports.start = start;
...
},{"./genericsUtils":2}],4:[function(require,module,exports){
...
},{"./adapters/http":5,"./adapters/xhr":5,"./core/enhanceError":15,"./helpers/normalizeHeaderName":27,"./utils":31,"_process":33}],20:[function(require,module,exports){
'use strict';
